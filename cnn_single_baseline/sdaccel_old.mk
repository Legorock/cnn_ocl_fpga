...
#xocc --xdevice ${XDEVICE} -t hw_emu -o ${XCLBIN_NAME}.xclbin ${KERNEL_FUNC} -s --report estimate -j 4 -O3 ${KERNEL_SRCS}

xocc --xdevice ${XDEVICE} -t hw_emu -o ${XCLBIN_NAME}.xclbin --report estimate -s -j 4 -O3 ${KERNEL_SRCS}
